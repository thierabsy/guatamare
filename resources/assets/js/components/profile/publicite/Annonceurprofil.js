...
const Annonceurprofil = ({dz, preview, handlePicker, showPicker, pickedColor, color}) => {
        return (
            <div className="auteurprofil">
                <form action="" onSubmit={submitProfil}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="file" className="form-control" id="catalogue" name="catalogue" placeholder="Entrez votre catalogue" />
                    </div>
